...
module.exports = ({ config, env }) => {
  ...
  config.resolve.alias['react-native-web/dist/exports/DatePickerIOS'] =
    '@react-native-community/datetimepicker';
  config.resolve.alias['react-native-web/dist/exports/PickerIOS'] =
    'react-native-web/dist/exports/Picker';
  config.resolve.alias['react-native-web/dist/exports/ProgressBarAndroid'] =
    'react-native-web/dist/exports/ProgressBar';
  config.resolve.alias['react-native-web/dist/exports/ProgressViewIOS'] =
    'react-native-web/dist/modules/UnimplementedView';
  config.resolve.alias['react-native-web/dist/exports/SegmentedControlIOS'] =
    'react-native-web/dist/modules/UnimplementedView';
