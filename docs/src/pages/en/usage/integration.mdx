...
Integrating with Flagship Code™ can be broken down into: configuring assets, configuring environments and linking / generating plugins. While this may seem tedious - this is a one-time setup that will empower you with idempotent native code generation to scale your application safely. You will no longer have to worry about maintaining those native code directories i.e. iOS and Android - just focus on React Native.
