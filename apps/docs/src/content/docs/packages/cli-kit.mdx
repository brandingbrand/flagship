...
This function type guards the `env.<mode>.ts`, which serves as the env configuration for your chosen ENV provider. For more detailed information, please refer to the [Environment Configuration](/guides/env) guide.
