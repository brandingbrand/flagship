...
```sh
yarn add --dev @brandingbrand/code-cli @brandingbrand/code-cli-kit @brandingbrand/code-preset-react-native
```
...
```sh
npm install --save-dev @brandingbrand/code-cli @brandingbrand/code-cli-kit @brandingbrand/code-preset-react-native
```
...
```sh
pnpm add --save-dev @brandingbrand/code-cli @brandingbrand/code-cli-kit @brandingbrand/code-preset-react-native
```
...
```sh
bun add --dev @brandingbrand/code-cli @brandingbrand/code-cli-kit @brandingbrand/code-preset-react-native
```
...
```json title="package.json" ins={10-12}
{
  "name": "my-awesome-app",
  "version": "1.0.0",
  "author": "Your Name <email@example.com>",
  ...
  "devDependencies": {
    ...
    "@brandingbrand/code-preset-react-native": "^1.0.0"
  }
}
```
