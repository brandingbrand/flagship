...
const screens: Screen[] = [
  { title: 'CMS Banner', screen: 'CMSBannerSample' }
];

export interface CMSSampleMenuProps extends ScreenProps, AccountProps {
  sampleScreen?: boolean;
}

class CMSSampleMenu extends Component<CMSSampleMenuProps> {
...
export default withAccount(CMSSampleMenu);
