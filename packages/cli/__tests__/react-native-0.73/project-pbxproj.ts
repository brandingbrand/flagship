/**
 * @jest-environment-options {"requireTemplate": true, "fixtures": "../project-pbxproj_fixtures", "reactNativeVersion": "0.73"}
 */
...
import transformer from '../../src/transformers/transformers-0.73/ios/project-pbxproj';
...
describe('ios project.pbxproj transformers', () => {
  ...
  it('should update project.pbxproj with xcode source, header and entitlements files', async () => {
    ...
    expect(content).toContain(
      '/* PrivacyInfo.xcprivacy */ = {isa = PBXFileReference; lastKnownFileType = text.xml; name = PrivacyInfo.xcprivacy; path = app/PrivacyInfo.xcprivacy; sourceTree = "<group>"; };',
    );
