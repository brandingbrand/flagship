...
import transformer from '../../src/transformers/transformers-0.73/android/build-gradle';
...
describe('build.gradle transformers', () => {
  ...
  it('should update kotlinVersion', async () => {
    const config = {
      ...__flagship_code_build_config,
    } as BuildConfig;
    config.android.gradle = {
      projectGradle: {
        kotlinVersion: '1.10.0',
      },
    };
    ...
    expect(content).toContain('kotlinVersion = "1.10.0"');
  });
