import type { SerializableVideoBlockProps, StateType } from './SerializableVideoBlock.types';
...
export class SerializableVideoBlock extends Component<SerializableVideoBlockProps, StateType> {
  ...
  renderHttp = (src: string, { width, height }: any) => {
    const { resizeMode = 'cover', autoPlay = false, repeat = false, muted = false } = this.props;
  ...
  render(): JSX.Element {
    const { source, ratio, style = {} } = this.props;
