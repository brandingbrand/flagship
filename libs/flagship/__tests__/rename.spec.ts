...
const createFile = (filePath: string, body = ''): void => {
...
describe('rename', () => {
  ...
  it('old file removed after rename file', () => {
    createFile(kFileNameOld);
    rename.files('OldName', 'NewFile', __dirname, testDirName);
  ...
  it('rename source code no match', () => {
  ...
  it('rename source code in lowercase', () => {
  ...
  it("don't rename source code under Pods folder", () => {
