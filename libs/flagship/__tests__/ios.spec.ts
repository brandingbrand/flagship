...
describe('ios', () => {
  ...
  it(`add exception domains by string`, () => {
  ...
  it(`add exception domains by object`, () => {
    ios.exceptionDomains({
      name: appName,
  ...
  it(`add exception domains with disableDevFeature turned off`, () => {
    ios.exceptionDomains({
      name: appName,
    } as any);
  ...
  it(`add exception domains with disableDevFeature turned on`, () => {
    ios.exceptionDomains({
      name: appName,
  ...
  it('provide custom bundle version number', () => {
    const version = '1.3.2';
    ios.version(
      {
        name: appName,
  ...
  it('provide custom short version number', () => {
    const version = '1.3.2';
    ios.version(
      {
        name: appName,
  ...
  it('targeted device should default to ios only', () => {
    ...
    for (const match of targetMatches || []) {
      expect(match).toBe('TARGETED_DEVICE_FAMILY = "1"');
    }
  });
});
