...
* **fscommerce:** add webcheckouturl type (27016f2)
...
* **fscommerce:** added createProductList interface (94848ed)
...
* **fscommerce:** add new querySuggestions prop to SearchSuggestions (1f80514)
...
* **fscommerce:** reduce scope of product group interface (ff59f62)
...
* **fscommerce:** export types without namespace (6862c1b)
...
- exported currency value from it's own type file instead of index (6cf02be)
...
- **title:** no-ticket - added title to product index type (9e4870b)
- **title:** no-ticket - made title optional (44e508b)
