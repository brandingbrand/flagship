  ...
  render(): JSX.Element {
    ...
    if (textOverlay) {
      textContainerStyle = {
        ...
        marginBottom:
          textOverlay.verticalAlignment === 'bottom' ? textOverlay.verticalDistanceFromEdge : 0,
        marginTop:
          textOverlay.verticalAlignment === 'top' ? textOverlay.verticalDistanceFromEdge : 0,
      ...
      <Animatable.View
        ...
        style={[
          ...
          !this.isLoaded && typeof this.props.index === 'number' && this.props.index <= 1
            ? {
                transform: [{ translateX: this.props.index ? -viewportWidth : viewportWidth }],
              }
            : {},
        ]}
      >
