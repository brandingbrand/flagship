...
* **orchestrate-nx:** use target dependencies from nx.json (70ef778)


### Features

* **orchestrate-nx:** allow passing options (bea038f)
...
* **orchestrate-nx:** calculate and run dependencies of targets (d0f11d4)
