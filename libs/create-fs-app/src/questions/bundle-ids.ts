...
const android: DistinctQuestion = formatters.android({
  ...
  suffix: 'This ID uniquely identifies your app on the device and in Google Play Store. Typically follows the convention of "com.[organization].[application]".',
...
const ios: DistinctQuestion = formatters.ios({
  ...
  suffix: 'This ID uniquely identifies your app on the device. Typically follows the convention of "com.[organization].[application]".',
  validate: requiredString
});
