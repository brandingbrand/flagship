...
# [11.82.0](https://github.com/brandingbrand/flagship/compare/v11.81.0...v11.82.0) (2023-03-07)
...
* **fsapp:** guard invalidation on route changes (2c15b29)
...
* **fsapp:** activate route details in analytics (3dc2d25)
...
* **fsapp:** initial load on native (940a0a8)
...
* **fsapp:** update type util import (8efc0ba)
...
* **fsapp:** canActivate fallthrough logic (fde120f)
* **fsapp:** cargo hold in modals (2b63a42)


### Features

* **fsapp:** add activated route provider for web shell (9ffefda)
* **fsapp:** route guard types (35cef95)
...
* **fsapp:** remove namespace exports (98d739c)
...
* **fsapp:** detecting loadable component dependency (e251075)


### Features

* **fsapp:** export activateed route provider (78651e1)
...
* **fsapp:** ensure route details are retained for the lifetime of the screen (85bb768)
...
* **fsapp:** integrate cargo hold into fsapp (2a46228)
...
* **fsapp:** switch tabs on pop (ca79a4b)
...
* **fsapp:** stable modal context value (6fb3440)
...
* **fsapp:** store modal provider (c1fe3ad)
...
* **fsapp:** wait for modal to close before reloading (c8a83af)
...
* **fsapp:** android remove animations on replace (76105e6)


### Features

* **fsapp:** router replace functionality updated (60ea67d)
...
* **fsapp:** default env fallback (4a4e7c2)


### Features

* **fsapp:** error message when envs are missing (27c4652)
* **fsapp:** use monorepo compatible env (099d68f)
...
- **fsapp:** stuck router after external navigation (e82c03c)

# [11.6.0](https://github.com/brandingbrand/flagship/compare/v11.5.0...v11.6.0) (2021-11-10)

### Bug Fixes

- **fsapp:** only use tab affinity for open() (f7fb0ce)
...
- **fsapp:** default modal type (85f51ec)
...
- Enable redux middleware in FSApp config (9e2e7b8)
- useButtonEffect (8fd9ff7)
...
- make Tab nullable (d8f503c)
- use tab id instead of title for tabAffinity (1124d58)

# [11.0.0-alpha.14](https://github.com/brandingbrand/flagship/compare/v11.0.0-alpha.13...v11.0.0-alpha.14) (2021-03-22)

### Bug Fixes

- update web interface (3b33752)

### Features

- allow custom nav bar styles on makeModal (37b70e0)
...
- **fsapp:** linking conflicts (ae906ab)
- **fsapp:** missing type definitions (945672b)

### Features

- **fsapp:** transfer state on push (0e58261)
...
- **fsapp:** build aliasing (60b7a45)

### Features

- **fsapp:** support top bar options (84060ae)
